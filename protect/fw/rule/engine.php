...
if (!class_exists('WPRProtectFWRuleEngine_V581')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V581 {
	use WPRProtectFWRuleStringFunc_V581;
	use WPRProtectFWRuleArrayFunc_V581;
	use WPRProtectFWRuleMiscFunc_V581;
	use WPRProtectFWRuleRequestFunc_V581;
	use WPRProtectFWRuleWPFunc_V581;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V581::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V581 $e) {
			$this->error = $e;
		}
	}
